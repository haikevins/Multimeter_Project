 ...
 */
static volatile char usart1_rx_buffer[USART1_RX_BUFFER_SIZE];
...
/**
  ...
  * @retval None
  */
inline void Usart1_Send_Char(char chr) {
...
/**
  ...
  * @retval None
  */
inline void Usart1_Send_String(char *str) {
  if (!str) return;
